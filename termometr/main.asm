...
; Имена регистров, а также различные константы
    .equ     XTAL                     = 8000000         ; Частота mc
    .equ     UART_BaudRate             = 19200            ; Скорость обмена по UART
    .equ     UART_BaudDivider         = XTAL/(16UART_BaudRate)-1
    .equ     I2C_Frequency             = 80000            ; Частота шины I2C
    .equ     I2C_BaudDivider         = (XTAL/(8I2C_Frequency)-2)
    .equ    Bit0                    = 0b00000001
    .equ    Bit1                    = 0b00000010
    .equ    Bit2                    = 0b00000100
    .equ    Bit3                    = 0b00001000
...
;=================================================
    .equ    SegPORT                 = PORTD            ;было PORTC
    .equ    SegDDR                  = DDRD            ;было DDRC
    .equ    DigPORT                 = PORTB
    .equ    DigDDR                  = DDRB
    .equ    Digit1                  = 1                ;0
    .equ    Digit2                  = 2
...
Decoder:
    LDI     ZL, LOW(LedMatrix2)
    LDI     ZH, HIGH(LedMatrix2)
    ADD     ZL, Temp1
    ADC     ZH, Temp0
    LPM     Temp1, Z
RET
